...
description: "온톨로지 초보자의 눈높이에서 OpenCrab의 9-Space를 노드 타입 목록이 아닌 도메인 해석 렌즈로 읽고, LLM 추출, MCP·SSOT, promotion과 Pack 구조의 의도와 한계를 분석합니다."
date: 2026-07-21
tags:
  - 온톨로지
  - OpenCrab
...
2. **MCP는 Agent가 승인된 문법과 해석 계획을 확인하고 온톨로지를 조작하는 공식 창구다.**
...
2. **MCP는 Agent가 승인된 렌즈·문법을 확인하고 온톨로지를 조작하는 창구이지, 데이터베이스 자체는 아니다.**
