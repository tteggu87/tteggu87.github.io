...
description: "Panasonic, Tampa General, SOMPO, Ursa Major, NHS, Airbus의 Palantir Foundry·AIP 사례를 production 사용과 효과 증거로 분리하고, 고객 사례의 숫자를 어디까지 믿을지 판단하는 증거 영수증을 제안합니다."
date: 2026-08-30
tags:
  - 팔란티어
  - Foundry
...
같은 “팔란티어 성공 사례” 안에서도 숫자의 뜻은 전혀 다를 수 있습니다. Tampa General Hospital은 환자 배치 관리 시간 83% 감소를 보고했고, Ursa Major는 연간 10,000~15,000시간의 엔지니어링 시간 절감을 **전망**했습니다. NHS의 Federated Data Platform은 실제 운영 지표를 공개하지만, NHS 자체 방법론은 전후 변화만으로 원인과 결과를 단정할 수 없다고 적습니다. ([Tampa General Hospital](https://www.tgh.org/news/tgh-press-releases/2024/june/tgh-selects-palantir-ai-software-connected-care-coordination), [Ursa Major](https://ursamajor.com/media/blog/how-ursa-major-and-palantir-are-solving-manufacturing-challenges-at-hypersonic-speeds/), [NHS England methodology](https://www.england.nhs.uk/digitaltechnology/nhs-federated-data-platform/impact/fdp-uptake-and-benefits/methodology-uptake-and-benefits-information/))

숫자만 나란히 놓으면 83%, 10,000시간, 수술 건수 같은 값이 모두 같은 종류의 성과처럼 보입니다. 하지만 하나는 고객이 보고한 운영 지표이고, 하나는 미래 전망이며, 다른 하나는 외부 요인을 통제하지 않은 관찰 비교입니다. 제품을 검토하는 사람에게 필요한 것은 더 큰 숫자가 아니라 **그 숫자가 어떤 업무에서, 누구의 보고로, 어떤 비교 조건 아래 나온 것인지 복원하는 방법**입니다.

> [!summary] 먼저 결론
> Palantir 사례는 `도입됨 → 사용됨 → 효과가 남 → Palantir이 원인임`이라는 한 줄로 읽으면 안 됩니다. 한 사례를 **운영 결정, 실제 사용 상태, 효과 증거 수준, 동시 개입, 비교 기준**으로 나눠 적으면, 고객 사례는 홍보 숫자가 아니라 검증 가능한 의사결정 재료가 됩니다.

## 먼저 “어디에 썼는가”를 업무 결정으로 바꿉니다

Palantir의 공식 use-case 문서는 기술이나 데이터 소스보다 먼저 특정 사용자의 **운영 결정과 결과(outcome)**를 정하라고 설명합니다. 이후 필요한 데이터를 연결하고, 조직의 객체와 업무 과정을 모델링하고, 사용자가 결정을 내릴 인터페이스와 결과 기록을 붙이는 흐름입니다. ([Delivering a use case](https://www.palantir.com/docs/foundry/getting-started/delivering-a-use-case), [Use case lifecycle](https://www.palantir.com/docs/foundry/use-case-life-cycle/overview))

공개 사례도 산업 이름보다 운영 결정으로 다시 쓰면 공통점이 보입니다.
...
이 표에서 “AI”라는 단어는 오히려 뒤로 물러납니다. 반복되는 것은 **정해진 운영 문제, 필요한 데이터, 업무 객체, 현장 사용자와 실제 조치**입니다. 28번 글에서 살펴본 [[notes/온톨로지/palantir-foundry-aip-operational-loop|Foundry·Ontology·AIP의 운영 루프]]가 기능의 책임 지도를 보여 줬다면, 이번에는 그 지도가 실제 사례에서 어디까지 도달했는지를 확인하는 쪽에 초점을 맞춥니다.

## 같은 production 사례도 효과 증거는 다를 수 있습니다

제품이 실제 업무에 쓰인다는 사실과 제품 때문에 결과가 좋아졌다는 사실은 다른 주장입니다. 이를 섞지 않으려고 프로젝트 연구에서는 두 축을 따로 두었습니다. 이 분류는 Palantir의 공식 등급이나 업계 표준이 아니라, 공개 사례의 주장 강도를 일정하게 읽기 위한 내부 도구입니다.
...
검토한 여섯 핵심 사례에서는 **E4에 해당하는 공개 인과 평가를 확인하지 못했습니다.** 그렇다고 사례가 쓸모없다는 뜻은 아닙니다. U3/E2는 “여러 workflow에서 실제 사용되며 고객이 운영 지표를 보고했다”는 강한 운영 근거가 될 수 있습니다. 다만 그 문장을 “제품이 그 개선을 일으켰다”로 바꾸는 순간 필요한 증거가 달라집니다.
...
## 여섯 사례를 같은 영수증으로 다시 읽어봅니다

사례를 비교할 때 제품 기능 수나 산업의 화려함을 기준으로 바꾸지 않고, 같은 질문을 반복해 보겠습니다.
...
이 표의 목적은 여섯 조직을 순위화하는 데 있지 않습니다. 오히려 **사용 증거가 강한 사례와 효과 귀속이 강한 사례는 같은 축에 있지 않다**는 점을 보여 줍니다.

## Tampa General의 83%는 무엇을 말하고, 무엇을 말하지 않을까요
...
이 수치는 “실제 병원 workflow에 Palantir이 깊게 들어갔다”는 판단에는 유용합니다. 하지만 병원 전체의 Care Coordination Center는 Palantir만으로 구성되지 않았습니다. Tampa General의 프로그램 페이지와 후속 자료에는 GE Healthcare를 포함한 여러 운영 체계와 개입이 함께 나타납니다. ([TGH Care Coordination Center](https://www.tgh.org/about-tgh/care-coordination-center))

그래서 증거 영수증에는 숫자 옆에 다음 두 줄이 붙어야 합니다.
...
이 두 줄을 지우면 83%는 “Palantir이 만든 효과”처럼 읽히기 쉽습니다. 붙여 놓으면 더 정확한 문장이 됩니다. **Tampa General이 Palantir partnership을 포함한 운영 변화에서 해당 지표 개선을 보고했다.**

## Ursa Major의 10,000~15,000시간은 아직 결과가 아니라 전망입니다
...
같은 글에서 “몇 달간 배포한 도구가 연간 10,000~15,000시간의 engineering time을 절약할 것으로 전망한다”고 적습니다. 여기서 동사는 **projected**입니다. 실제 1년의 누적 절감 시간을 사후 측정했다는 문장이 아닙니다.
...
따라서 Ursa Major는 `U2 / E1`로 읽는 편이 안전합니다. Production 사용의 구체성은 높지만, 절감 시간은 아직 전망입니다. “production에서 쓰인다”와 “예상한 절감이 실현됐다”를 분리하면 사례의 강점은 유지하면서 과장을 피할 수 있습니다.

## SOMPO는 여러 해의 운영 기록이 있어도 단독 인과는 남습니다
...
이 사례는 일회성 발표보다 강합니다. 여러 해의 고객 연차보고서에 실제 운영 방식이 반복해서 등장하기 때문입니다. 동시에 SOMPO는 pricing 조정, 상품·underwriting reform, 생산성 개선을 함께 추진했습니다. 장기간 관찰했다는 이유만으로 소프트웨어 한 요소의 순기여가 자동 분리되지는 않습니다.

영수증의 `duration`은 강해졌지만 `counterfactual`은 여전히 비어 있는 셈입니다.

## Panasonic과 Airbus는 “Foundry-era outcome”이라는 시간 경계를 봐야 합니다
...
Airbus의 Skywise는 더 오래된 사례입니다. Airbus는 2017년 Palantir과 함께 Skywise를 시작하면서 work order, spare consumption, aircraft configuration, sensor와 flight schedule 같은 데이터를 연결해 predictive maintenance와 fleet reliability에 쓰겠다고 발표했습니다. 현재 Skywise 자료에는 고객 testimonial 형태의 시간·정비 절감 수치도 있습니다. ([Airbus, 2017](https://www.airbus.com/en/newsroom/press-releases/2017-06-airbus-launches-skywise-aviations-open-data-platform), [Skywise Core](https://www.skywise.com/en/digital-platform/skywise-core))

두 사례는 “통합된 운영 데이터 모델이 장기적인 workflow에 쓰인다”는 근거로는 중요합니다. 다만 **AIP가 일반 제공되기 전부터 축적된 Foundry-era 결과를 현재 AIP의 고유 효과로 옮겨 적으면 시간축이 사라집니다.** AIP가 무엇을 추가했는지 보려면 같은 workflow에서 Foundry-only 상태와 AIP-added 상태를 따로 비교해야 합니다.

## NHS 사례가 중요한 이유는 숫자가 크기 때문이 아닙니다
...
이 방식의 장점은 사례를 좋다·나쁘다로 바로 분류하지 않는 데 있습니다. 예를 들어 Tampa General은 production 규모와 고객 보고가 강하지만 attribution이 약합니다. Ursa Major는 workflow가 구체적이지만 효과 숫자는 projection입니다. NHS는 운영 규모와 독립 검토가 함께 있지만 긍정적 인과 결론은 닫히지 않았습니다.

## 내 조직에서 “우리도 저렇게 될까?”를 묻는 가장 작은 방법
...
반대로 고객 사례를 모두 “마케팅”이라고 버리는 것도 정보 손실입니다. 고객 자료는 어떤 데이터를 연결했고 어떤 사용자가 어떤 workflow에서 제품을 썼는지 파악하는 데 매우 유용합니다. 다만 그 자료가 답할 수 없는 질문까지 대신 답하게 하지 않으면 됩니다.
...
새 공급자나 Agent 플랫폼의 사례를 볼 때는 먼저 한 장의 증거 영수증을 채워 보십시오. `무슨 결정을 바꿨는가`, `실제로 어디까지 production에 들어갔는가`, `효과 수치는 누가 보고했는가`, `동시에 무엇이 바뀌었는가`, `비교 기준은 있는가`가 채워지지 않는다면 숫자가 커도 아직 구매 근거는 약합니다. 반대로 이 칸들이 명확하다면 작은 사례라도 다음 검증을 설계할 수 있습니다.
