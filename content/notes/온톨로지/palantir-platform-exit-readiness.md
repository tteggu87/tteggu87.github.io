...
> switching friction·exit capability·exit readiness·post-exit evidence를 서로 다른 판단 축으로 나누는 분류는 Palantir의 공식 제품 모델이나 업계 표준 분류가 아니라, 아래 공개 근거를 비교하기 위해 사용한 프로젝트 분석 프레임입니다.
...
아래에서는 이 분석 프레임을 실제 전환 준비 항목으로 풀어 보겠습니다.
