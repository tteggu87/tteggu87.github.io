...
1. [[notes/온톨로지/ontology-agent-guide|1. 온톨로지 에이전트]]: 온톨로지·지식그래프·LLM·에이전트의 기본 경계를 잡습니다.
2. [[notes/온톨로지/ontology-agent-behavior-experiment|5. 온톨로지 도입 비교 실험]] → [[notes/온톨로지/ontology-vs-json-rules|6. JSON 규칙과 온톨로지]]: 언제 온톨로지가 필요한지 기준선을 세웁니다.
3. [[notes/온톨로지/opencrab-ontology-build-architecture|8. OpenCrab 온톨로지 빌드]] → [[notes/온톨로지/ontology-context-compiler-opencrab|9. 문맥 컴파일러]] → [[notes/온톨로지/ontology-expertise-pack|10. Expertise Pack]]: 지식을 만들고 질문에 공급하는 구조를 봅니다.
