...
>
> 이 글은 온톨로지 기반 에이전트의 개념과 구현 구조를 한 번에 이해할 수 있도록 정리한 첫 번째 발행글이다. 이후 연구 흐름은 [[notes/온톨로지/ontology-in-the-agentic-era|2. LLM 에이전트 시대의 온톨로지]]로 이어진다.
